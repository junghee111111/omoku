...
function showToast(message,icon="fa-spinner",spin=true,double=false){
    $(".overlay").show();
    $(".overlay>.Toast").show();
...
function showModal(type='1',message,callback=function(){hideModal();},icon="fas fa-question-circle",spin=false){
    $(".overlay").show();
    $(".overlay>.Modal").show();
